...
<reference>
@/Users/teaghanjohnson/nba-fantasy/.claude/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `/Users/teaghanjohnson/nba-fantasy/.claude/get-shit-done/references/user-profiling.md` to load:
