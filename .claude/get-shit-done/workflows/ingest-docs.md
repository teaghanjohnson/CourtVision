...
```bash
INIT=$(node "/Users/teaghanjohnson/nba-fantasy/.claude/get-shit-done/bin/gsd-tools.cjs" init ingest-docs)
...
```bash
node "/Users/teaghanjohnson/nba-fantasy/.claude/get-shit-done/bin/gsd-tools.cjs" commit \
