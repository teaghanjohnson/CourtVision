...
```bash
INIT=$(node "/Users/teaghanjohnson/nba-fantasy/.claude/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @/Users/teaghanjohnson/nba-fantasy/.claude/get-shit-done/templates/spec.md.
