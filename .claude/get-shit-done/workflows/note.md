...
- **Global scope**: `/Users/teaghanjohnson/nba-fantasy/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/teaghanjohnson/nba-fantasy/.claude/notes/`)
...
2. Glob `/Users/teaghanjohnson/nba-fantasy/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/Users/teaghanjohnson/nba-fantasy/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/teaghanjohnson/nba-fantasy/.claude/notes/` — works in any directory
