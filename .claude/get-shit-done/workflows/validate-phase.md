...
```
Agent(
  prompt="Read /Users/teaghanjohnson/nba-fantasy/.claude/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/teaghanjohnson/nba-fantasy/.claude/get-shit-done/templates/VALIDATION.md`
