...
def normalize_player(raw: dict) -> dict:
    ...
    return {
        ...
        "ppg": raw.get("pointsPerGame"),
        "rpg": raw.get("reboundsPerGame"),
        "apg": raw.get("assistsPerGame"),
        "stl": raw.get("stealsPerGame"),
        "blk": raw.get("blocksPerGame"),
        ...
        "tov": raw.get("turnoversPerGame"),
        "pfpg": raw.get("foulsPerGame"),
        "effpg": raw.get("efficiencyPerGame"),
        "plusMinusPerGame": raw.get("plusMinusPerGame"),
        # totals
